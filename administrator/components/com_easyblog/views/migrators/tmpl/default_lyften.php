...
function migrateLyftenBloggie()
{
	ej( "#migrator-submit3" ).attr('disabled' , 'true');
	ej( "#migrator-submit3" ).html('Updating ...');

	ej( "#no-progress3" ).css( 'display' , 'none' );
	ej( "#icon-wait3" ).css( 'display' , 'block' );
	ej( "#progress-status3" ).html( '' );
...
function divSrolltoBottomLyften()
{
